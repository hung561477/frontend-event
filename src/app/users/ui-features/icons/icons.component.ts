...
export class IconsComponent {
  ...
  icons = {
    ...
    nebular: ['nb-alert', 'nb-angle-double-left', 'nb-angle-double-right',
      ...
      'nb-heart', 'nb-page', 'nb-keypad', 'nb-layout-centre', 'nb-layout-default', 'nb-layout-one-column',
    ...
    ionicons: [
      ...
      'ion-refresh', 'ion-loop', 'ion-shuffle', 'ion-page', 'ion-search', 'ion-flag', 'ion-star',
